            ...
            <div className={`${styles.ContainerWidth}`}>
                <div className="row" style={{ maxWidth: '1000px', margin: 'auto' }}>
                    ...
                    <div className="col-lg-6 p-lg-5 pt-5">
                        ...
                        <p className={`${styles.sectionBody}`}>Hubstaff is a fully remote company that believes a global talent pool is a competitive advantage. We have no corporate campus, no cubicles, no geographic limit to who we can hire, and our products are better for it. Our team is always growing.</p>
