            ...
            <div className={`${styles.ContainerWidth}`}>
                <div className={`row`}>
                    ...
                    <div className={`col-lg-6 pb-lg-0 pb-5 pt-lg-0 pt-5 px-lg-5`}>
                        <h1 className={`${styles.sectionTitle} py-lg-5 py-3`}><b>How Hubstaff's agency time tracking software works</b></h1>
                        <div class={`${styles.timelines} ${styles.education}`}>
                            <div class={`${styles.timelineItems}`}>
                                ...
                                <div class={`${styles.timelineItem}`}>
                                    ...
                                    <p className={`${styles.sectionBody} text-muted`}>Set client budgets and get automatic alerts as you approach them. See hours spent, detailed timesheets, and budget progress all from your Hubstaff dashboard.</p>
                                </div>
                            </div>
                        </div>
                    </div>
