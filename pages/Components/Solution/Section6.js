    ...
    return (
        <div className={`px-md-4 px-3 py-5`} style={{ background: "#3F5FFF" }}>
            <div className={`${styles.ContainerWidth} py-md-5 py-3`}>
                <h1 className={`${styles.sectionTitle} text-white text-center`}><b>Try Hubstaff free for 14 days</b></h1>
                ...
                <div className='text-center'>
                    <button type="button" class={`btn ${styles.ReadAllAboutit}`}>Try Hubstaff Now</button>
                </div>
            </div>
        </div>
    )
