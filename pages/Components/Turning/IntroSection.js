...
export default function IntroSection() {
    ...
    function moveOnFirstboardingPages(e) {
        ...
        router.push({ pathname: 'FirstPage',
            ...
            <div className={`${styles.ContainerWidth}`}>
                <div className="row">
                    <div className={`${styles.imgStyle} col-xl-6 col-lg-5 order-lg-2 pb-lg-0 pb-3`}>
                        <img src="https://lh3.googleusercontent.com/SwtoSddZg_3TbMSRtmajA4kUV7xrS_MoRzoUJRWbtxLv7aF7B-m0mlFj4ucKEkfBWA816hs8W5wQakjI7kLFjjr2MDfYyiXeWdZp2hd6" alt="#ImgNotFound" className={`w-100`} />
                    </div>
                    <div className={`col-xl-6 col-lg-7 py-5 mt-xxl-5`}>
                        ...
                        <form onSubmit={(e) => moveOnFirstboardingPages(e)}>
                            <div class="input-group my-5">
                                <input type="email" required class="form-control py-2" placeholder="Your Work Email" aria-describedby="basic-addon2" onChange={(e) => setEmailAddress(e.target.value)} />
                                <button type='submit' class="input-group-text bg-primary text-white" id="basic-addon2" style={{ border: 'none' }}>Talk to an Expert</button>
                            </div>
                        </form>
                        <h5 className={`${styles.sectionBody} pt-2`}>
