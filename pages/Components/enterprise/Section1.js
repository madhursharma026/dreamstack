...
export default function Section1() {
    return (
        <div className={`p-0 mt-5 ${styles.IntroSection}`} style={{ background: "#3F240D" }}>
            <div className={`${styles.ContainerWidth}`}>
                <div className={`row ${styles.sectionRow}`}>
                    <div className={`col-lg-6 order-lg-2 pb-lg-0 pb-3`}>
                        <img src="https://s7ap1.scene7.com/is/image/TCSCOMprod/eas-wwd?wid=2000&hei=788&dpr=off" alt="#ImgNotFound" className={`${styles.imgStyle} w-100 h-100`} style={{ border: '0' }} />
                    </div>
