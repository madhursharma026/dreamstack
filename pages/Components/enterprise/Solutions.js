        ...
        <div className={`${styles.ContainerWidth} px-3 mb-3`}>
            <Accordion style={{ maxWidth: '1200px', margin: 'auto' }}>
                ...
                <Accordion.Item eventKey="0">
                    <Accordion.Header><h2>01. TCS Decision Fabric <sup>TM</sup></h2></Accordion.Header>
                    <Accordion.Body>
                        <div className="row">
                ...
                <Accordion.Item eventKey="1">
                    <Accordion.Header><h2>02. TCS Datom <sup>TM</sup></h2></Accordion.Header>
                    <Accordion.Body>
                        <div className="row">
                            <div className="col-sm-4">
                                <img src="https://www.tcs.com/content/dam/global-tcs/en/images/what-we-do/services/cyber-security/blogs/cloud-security-automation-cyber-hygiene-card-1330x1270.jpg/jcr:content/renditions/cq5dam.thumbnail.1280.765.png" alt="#ImgNotFound" className='w-100' />
                ...
                <Accordion.Item eventKey="2">
                    <Accordion.Header><h2>03. TCS Daezmo <sup>TM</sup></h2></Accordion.Header>
                    <Accordion.Body>
                        <div className="row">
                            <div className="col-sm-4">
                                <img src="https://www.tcs.com/content/dam/global-tcs/en/images/what-we-do/services/cyber-security/blogs/cloud-security-automation-cyber-hygiene-card-1330x1270.jpg/jcr:content/renditions/cq5dam.thumbnail.1280.765.png" alt="#ImgNotFound" className='w-100' />
                ...
                <Accordion.Item eventKey="3">
                    <Accordion.Header><h2>04. TCS Dexam <sup>TM</sup></h2></Accordion.Header>
                    <Accordion.Body>
                        <div className="row">
                            <div className="col-sm-4">
                                <img src="https://www.tcs.com/content/dam/global-tcs/en/images/what-we-do/services/cyber-security/blogs/cloud-security-automation-cyber-hygiene-card-1330x1270.jpg/jcr:content/renditions/cq5dam.thumbnail.1280.765.png" alt="#ImgNotFound" className='w-100' />
